...
<nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" style="z-index:3;width:250px" id="mySidebar">
  ...
  <div class="w3-padding-64 w3-large w3-text-grey" style="font-weight:bold">
    ...
    <a href="http://localhost/wdl/mycart.php" class="w3-button w3-block w3-white w3-left-align">My Cart</a>
  </div>
...
<div style="clear: both"></div>
        ...
        <div class="table-responsive">
            ...
            <button type="submit" class="button button2" style="float: right;">Checkout</button>
            <input type="button" class="button button1" onclick="location.href='http://localhost/wdl/index.php'; "value="Continue Shopping" />
            </form>
